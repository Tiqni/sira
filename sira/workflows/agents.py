...
resume_parser_agent = Agent(
    ...
    5a. Skill NAMES are the one exception to rule 5: list each skill once, under its
        plain name, without version numbers or spelling variants ("Python 3.13+" and
        "Python" are one skill: "Python"). Keep the versions and original wording in the
        summary and experience bullets. Team names, company or product names, job titles
        and configuration vocabulary ("environment variable", "Data Platform Team",
        "Yahoo") are NOT skills — leave them out of skill_groups.
