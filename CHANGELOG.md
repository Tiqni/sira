...
- release sira on PyPI (#17)

## v1.4.0 (2026-09-15)

### Feat

- **scraper**: detect prompt injection in scraped job postings (#14)

## v1.3.0 (2026-09-14)

### Feat

- semantic job skill matching and python-computed match score (#12)

## v1.2.0 (2026-09-14)

### Feat

- durable execution with dbos (#10)

## v1.1.0 (2026-09-01)

### Feat

- deterministic job-scraper fetch (fixes networkidle timeout) (#5)
